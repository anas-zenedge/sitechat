...
builder.Services.AddSingleton<MongoSiteChatRepository>();
builder.Services.AddSingleton<IMongoInfrastructureRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
builder.Services.AddSingleton<IUserRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
builder.Services.AddSingleton<ISiteRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
builder.Services.AddSingleton<IConversationRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
builder.Services.AddSingleton<ICrawlJobRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
builder.Services.AddSingleton<IPageRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
builder.Services.AddSingleton<ISystemRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
builder.Services.AddSingleton<IPlatformConfigurationRepository>(serviceProvider => serviceProvider.GetRequiredService<MongoSiteChatRepository>());
